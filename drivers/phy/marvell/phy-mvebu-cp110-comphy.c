...
#define MVEBU_COMPHY_CONF(_lane, _port, _submode)	\
	{					\
		.lane = _lane,			\
		.port = _port,			\
...
static const struct mvebu_comhy_conf mvebu_comphy_cp110_modes[] = {
	/* lane 0 */
	MVEBU_COMPHY_CONF(0, 1, PHY_INTERFACE_MODE_SGMII),
	MVEBU_COMPHY_CONF(0, 1, PHY_INTERFACE_MODE_2500BASEX),
	/* lane 1 */
	MVEBU_COMPHY_CONF(1, 2, PHY_INTERFACE_MODE_SGMII),
	MVEBU_COMPHY_CONF(1, 2, PHY_INTERFACE_MODE_2500BASEX),
	/* lane 2 */
	MVEBU_COMPHY_CONF(2, 0, PHY_INTERFACE_MODE_SGMII),
	MVEBU_COMPHY_CONF(2, 0, PHY_INTERFACE_MODE_2500BASEX),
	MVEBU_COMPHY_CONF(2, 0, PHY_INTERFACE_MODE_10GKR),
	MVEBU_COMPHY_CONF(2, 0, PHY_INTERFACE_MODE_RXAUI),
	/* lane 3 */
	MVEBU_COMPHY_CONF(3, 1, PHY_INTERFACE_MODE_SGMII),
	MVEBU_COMPHY_CONF(3, 1, PHY_INTERFACE_MODE_2500BASEX),
	MVEBU_COMPHY_CONF(3, 0, PHY_INTERFACE_MODE_RXAUI),
	/* lane 4 */
	MVEBU_COMPHY_CONF(4, 0, PHY_INTERFACE_MODE_SGMII),
	MVEBU_COMPHY_CONF(4, 0, PHY_INTERFACE_MODE_2500BASEX),
	MVEBU_COMPHY_CONF(4, 0, PHY_INTERFACE_MODE_10GKR),
	MVEBU_COMPHY_CONF(4, 1, PHY_INTERFACE_MODE_SGMII),
	MVEBU_COMPHY_CONF(4, 0, PHY_INTERFACE_MODE_RXAUI),
	/* lane 5 */
	MVEBU_COMPHY_CONF(5, 2, PHY_INTERFACE_MODE_SGMII),
	MVEBU_COMPHY_CONF(5, 2, PHY_INTERFACE_MODE_2500BASEX),
	MVEBU_COMPHY_CONF(5, 0, PHY_INTERFACE_MODE_RXAUI),
};
