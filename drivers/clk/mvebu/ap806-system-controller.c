				     ...
				     struct device_node *reg_np)
{
	...
	name = ap806_unique_name(dev, reg_np, "cpu-cluster-0");
	...
	name = ap806_unique_name(dev, reg_np, "cpu-cluster-1");
	...
	fixedclk_name = ap806_unique_name(dev, reg_np, "fixed");
	...
	name = ap806_unique_name(dev, reg_np, "mss");
